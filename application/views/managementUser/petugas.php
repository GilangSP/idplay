						...
						<tr>
							...
							<td>
								<a class="nav-link collapsed" href="#" data-toggle="collapse"
									data-target="#menu<?= $u['id']; ?>" aria-expanded="true"
		...
		<div class="modal-content">
			...
			<form method="POST">
				...
				<div class="modal-body">
					...
					<div class="form-floating mb-2">
						<input type="password" class="form-control form-password" id="password" name="password"
...
<!-- Delete Modal-->
<div class="modal fade" id="deleteMenuModal" tabindex="-1" role="dialog" aria-labelledby="MenuModalLabel"
	aria-hidden="true">
