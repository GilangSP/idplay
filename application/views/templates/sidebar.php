...
<div class="wrapper">
    ...
    <div class="leftside-menu">
        ...
        <a href="<?= base_url('user'); ?>" class="logo text-center logo-light mt-2">
            <span class="logo-lg">
                <img src="<?= base_url(); ?>assets/images/Logo_Supercorridor.png" alt="" height="80">
            </span>
            <span class="logo-sm">
                <img src="<?= base_url(); ?>assets/images/Logo_Supercorridor.png" alt="" height="50">
            </span>
        </a>
        ...
        <a href="<?= base_url('user'); ?>" class="logo text-center logo-dark mt-2">
            <span class="logo-lg">
                <img src="<?= base_url(); ?>assets/images/Logo_Supercorridor.png" alt="" height="70">
            </span>
            <span class="logo-sm">
                <img src="<?= base_url(); ?>assets/images/Logo_Supercorridor.png" alt="" height="50">
            </span>
